...
if(isset($_POST['submit'])) {
    ...
    $pacient->nume=$_POST['nume'];
    $pacient->prenume=$_POST['prenume'];
    $pacient->email=$_POST['email'];
    
    $query1="SELECT * FROM pacienti WHERE email='$pacient->email'";
    ...
    $query="INSERT INTO pacienti(nume, prenume, email) VALUES ('$pacient->nume','$pacient->prenume','$pacient->email')";
    ...
    if(!$result) {
        ...
        header("Location: http://localhost:8080/Licenta/fise_tratament_create.php");
    }
    }
    else
    ?>
    <script>alert("Pacientul exista deja in baza de date");</script>
    <?php
}
?>
...
<body>
<h1 class="text-center">Adaugare Pacient</h1>
<div class="container">
    <div class="col-sm-6">
        <form action="pacienti_create.php" method="post">
   <div class="form-group">
    ...
    <div class="form-group">
    <label for="data_nasterii">Email</label>
