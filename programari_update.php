...
<form action="programari_update.php" method="post">
...
<?php 
        ...
        <input type="number" name="achitat"><br>
            ...
            <input class="btn btn-primary" type="submit" name="submit1" value="Modifica">
            </form>
            <?php 
            }
    ...
    if($achitat){
        $query4="UPDATE programari SET achitat='$achitat' WHERE id_programare='$id_programare'";
