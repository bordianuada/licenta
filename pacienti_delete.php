...
<div class="navbar">
  ...
  <div class="dropdown">
    ...
    <h1 class="text-center">Stergere pacient</h1>
    <div class="container">
        <div class="col-sm-6">
            <form action="pacienti_delete.php" method="post">
    ...
    $query1="DELETE FROM pacienti WHERE id_pacient='$id_pacient'";
    $query2="DELETE FROM fise_tratament WHERE id_pacient='$id_pacient'";
