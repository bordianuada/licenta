...
if(isset($_POST['submit'])) {
    ...
    $servicii->denumire=$_POST['denumire'];
    $servicii->pret=$_POST['pret'];
    $servicii->detalii=$_POST['detalii'];

    
    $query="INSERT INTO servicii(denumire, pret, detalii) VALUES ('$servicii->denumire','$servicii->pret','$servicii->detalii')";
...
<h1 class="text-center">Adaugare Serviciu</h1>
<div class="container">
    <div class="col-sm-6">
        <form action="servicii_create.php" method="post">
   <div class="form-group">
    ...
    <input type="text" name="detalii"><br>
    </div>
