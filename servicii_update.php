...
<div class="navbar">
  ...
  <div class="dropdown">
    ...
    <h1 class="text-center">Modificare servicii</h1>
    <div class="container">
        <div class="col-sm-6">
            <form action="servicii_update.php" method="post">
    ...
    if($pret){
    $query1="UPDATE servicii SET pret='$pret' WHERE id_servicii='$id_servicii'";
    ...
    if($detalii){
    $query1="UPDATE servicii SET detalii='$detalii' WHERE id_servicii='$id_servicii'";
